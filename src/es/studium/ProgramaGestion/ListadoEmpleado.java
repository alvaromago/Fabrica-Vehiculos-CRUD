	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource().equals(btnPdf))
		{
			...
			try
			{
				...
				tabla.addHeaderCell(new Cell().add(new Paragraph("Apellidos Empleado").setFont(fontHeader).setBold()));
				tabla.addHeaderCell(new Cell().add(new Paragraph("Correo Electrónico").setFont(fontHeader).setBold()));
