	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource().equals(btnPdf))
		{
			...
			try
			{
				...
				table.addHeaderCell(new Cell().add(new Paragraph("Nombre Empleado").setFont(fontHeader).setBold()));
				table.addHeaderCell(new Cell().add(new Paragraph("Apellidos Empleado").setFont(fontHeader).setBold()));
				table.addHeaderCell(new Cell().add(new Paragraph("Correo Electrónico").setFont(fontHeader).setBold()));

				// Agregar datos a la tabla desde el TextArea
				String[] lines = txaEmpleados.getText().split("\n");
